          ...
          <template v-slot:body>
            ...
            <div class="form-group">
              ...
              >
                ...
                <option
                  v-bind:value="
                    taskContext.processoIngresso.ingresso.estadio && EstadioOption.id === taskContext.processoIngresso.ingresso.estadio.id
                      ? taskContext.processoIngresso.ingresso.estadio
                      : EstadioOption
                  "
